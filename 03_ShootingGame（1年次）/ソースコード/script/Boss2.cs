...
public class Boss2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (bulletTimer >= bulletInterval)
        {
            ...
            for (int i = 0; i < 5; ++i)
            {
                // 315度(-45度)から45度の範囲でランダムな角度を生成
                Instantiate(bulletPrefab, transform.position, Quaternion.Euler(0, 0, Random.Range(315f, 405f) % 360));
            }
